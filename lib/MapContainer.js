...
var _eventsHandler = require('./utils/eventsHandler');
...
var YandexMap = function (_Component) {
    ...
    function YandexMap(props) {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(YandexMap).call(this, props));
    }
    ...
    _createClass(YandexMap, [{
        ...
        value: function componentDidMount() {
            if (_api2.default.isAvailible()) {
                ...
                _api2.default.load().then(this._onAPILoad.bind(this)).catch(function (error) {
        ...
        key: '_setupMarkers',
        value: function _setupMarkers() {
            var _this3 = this;

            _react2.default.Children.toArray(this.props.children).filter(function (component) {
                return component.type && component.type.name == 'MapMarker';
            }).forEach(function (component) {
                var clonedComponent = _react2.default.cloneElement(component, { mapController: _this3._controller });
                _reactDom2.default.render(clonedComponent, document.createElement('div'));
            });
        }
    }]);
...
exports.default = (0, _decorators.lifecycleDecorator)(YandexMap, { supportEvents: _map2.default });