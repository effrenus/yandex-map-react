    ...
    _createClass(YandexMap, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_MapElement2.default, { ref: function ref(node) {
                        _this3.mapContainer = node;
                    } }),
        ...
        value: function _onAPILoad(namespace) {
            ...
            this._controller.createMap(_reactDom2.default.findDOMNode(this.mapContainer), _extends({}, this.props.state, {
