...
var YandexPanorama = function (_Component) {
    ...
    _createClass(YandexPanorama, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { style: style },
                    _react2.default.createElement(_PanoramaElement2.default, { ref: function ref(node) {
                            _this3.panoramaPlayer = node;
        ...
        value: function _onAPILoad(namespace) {
            ...
            this._controller.createPanorama(_reactDom2.default.findDOMNode(this.panoramaPlayer), _extends({}, this.props.state, {
            ...
            this.setState({ isAPILoaded: true }, function () {
                return _this4._controller.locate(_this4.state.showService);
            });
        }
    }]);
